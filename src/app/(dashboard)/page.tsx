...
export default function Home() {
  return (
   <main className='w-full m-8'>
    ...
    <DashboardCard icon={<DollarSign className="h-4 w-4 text-muted-foreground" />}  title='Total Revenue' description='+20.1% from last month' amount='$45,231.89' />
    <DashboardCard icon={<Users2 className="h-4 w-4 text-muted-foreground" />}  title='Total Subscriber' description='+20.1% from last month' amount='$45,231.89' />
    <DashboardCard icon={<DollarSign className="h-4 w-4 text-muted-foreground" />}  title='Total Revenue' description='+20.1% from last month' amount='$45,231.89' />
    <DashboardCard icon={<DollarSign className="h-4 w-4 text-muted-foreground" />}  title='Total Revenue' description='+20.1% from last month' amount='$45,231.89' />
    </header>
